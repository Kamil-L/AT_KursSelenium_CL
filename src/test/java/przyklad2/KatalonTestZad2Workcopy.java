...
public class KatalonTestZad2Workcopy {
    ...
    public void fillFormWithProperData() {
        ...
        List<WebElement> rows = dateOfbirth.findElements(By.tagName("tr"));
        List<WebElement> columns = dateOfbirth.findElements(By.tagName("td"));
